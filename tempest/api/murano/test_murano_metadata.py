...
class SanityMuranoTest(base.MuranoMeta):
    ...
    def test_upload_file_and_delete_workflows(self):
        ...
        _, body1 = self.get_list_metadata_objects("workflows")

        self.delete_metadata_obj_or_folder("workflows/testfile.txt")

        self.assertEqual(resp.status_code, 200)
        self.assertIn('testfile.txt', body1['workflows'])

        _, body1 = self.get_list_metadata_objects("workflows")

        self.assertNotIn('testfile.txt', body1['workflows'])
    ...
    def test_upload_file_and_delete_ui(self):
        ...
        _, body1 = self.get_list_metadata_objects("ui")

        self.delete_metadata_obj_or_folder("ui/testfile.txt")

        self.assertEqual(resp.status_code, 200)
        self.assertIn('testfile.txt', body1['ui'])

        _, body1 = self.get_list_metadata_objects("ui")

        self.assertNotIn('testfile.txt', body1['ui'])
    ...
    def test_upload_file_and_delete_heat(self):
        ...
        _, body1 = self.get_list_metadata_objects("heat")

        self.delete_metadata_obj_or_folder("heat/testfile.txt")

        self.assertEqual(resp.status_code, 200)
        self.assertIn('testfile.txt', body1['heat'])

        _, body1 = self.get_list_metadata_objects("heat")

        self.assertNotIn('testfile.txt', body1['heat'])
    ...
    def test_upload_file_and_delete_agent(self):
        ...
        _, body1 = self.get_list_metadata_objects("agent")

        self.delete_metadata_obj_or_folder("agent/testfile.txt")

        self.assertEqual(resp.status_code, 200)
        self.assertIn('testfile.txt', body1['agent'])

        _, body1 = self.get_list_metadata_objects("agent")

        self.assertNotIn('testfile.txt', body1['agent'])
    ...
    def test_upload_file_and_delete_scripts(self):
        ...
        _, body1 = self.get_list_metadata_objects("scripts")

        self.delete_metadata_obj_or_folder("scripts/testfile.txt")

        self.assertEqual(resp.status_code, 200)
        self.assertIn('testfile.txt', body1['scripts'])

        _, body1 = self.get_list_metadata_objects("scripts")

        self.assertNotIn('testfile.txt', body1['scripts'])

        self.objs.pop(self.objs.index("scripts/testfile.txt"))

    @testtools.skip('Not working yet')
    @attr(type='smoke')
    def test_upload_file_and_delete_manifests(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(resp1.status, '200')
        self.assertIn('testfile.txt', body1['manifests'])
    ...
    def test_get_metadata_object(self):
        ...
        self.assertEqual(resp1.status, 200)
        self.assertIn('It\'s a test file', body1)
    ...
    def test_create_folder_and_upload_file_workflows(self):
        ...
        _, body1 = self.get_list_metadata_objects("workflows/testdir")
        ...
        _, body = self.get_list_metadata_objects("workflows")

        self.assertNotIn('testfile.txt', body['workflows'])
    ...
    def test_create_folder_and_upload_file_ui(self):
        ...
        _, body1 = self.get_list_metadata_objects("ui/testdir")
        ...
        _, body = self.get_list_metadata_objects("ui")

        self.assertNotIn('testfile.txt', body['ui'])
    ...
    def test_create_folder_and_upload_file_heat(self):
        ...
        _, body1 = self.get_list_metadata_objects("heat/testdir")
        ...
        self.assertEqual(resp.status, 200)
        self.assertNotIn('testfile.txt', body['heat'])
    ...
    def test_create_folder_and_upload_file_agent(self):
        ...
        _, body1 = self.get_list_metadata_objects("agent/testdir")
        ...
        self.assertEqual(resp.status, 200)
        self.assertNotIn('testfile.txt', body['agent'])
    ...
    def test_create_folder_and_upload_file_scripts(self):
        ...
        _, body1 = self.get_list_metadata_objects("scripts/testdir")
        ...
        self.assertEqual(resp.status, 200)
        self.assertNotIn('testfile.txt', body['scripts'])
    ...
    def test_switch_service_parameter(self):
        ...
        self.assertEqual(resp.status, 200)
        self.assertIn('success', body['result'])
